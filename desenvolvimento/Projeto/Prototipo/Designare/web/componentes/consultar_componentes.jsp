        ...
        <section id="application">
            <div class="container">
                <div class="area_application consultar_componentes">
                    ...
                    <h3 class="text-center">Consultar componentes criados</h3>
                    <div class="item_listagem">
                        <div>Ator: Usuário
                            <button type="submit" class="inline">EXCLUIR</button>
                            <button type="submit" class="inline">EDITAR</button>
                        </div>
                    </div>
                    
                    <div class="item_listagem">
                        <div>Ator: Funcionário
                            <button type="submit" class="inline">EXCLUIR</button>
                            <button type="submit" class="inline">EDITAR</button>
                        </div>
                    </div>
                    ...
                    <div class="item_listagem">
                        <div>Caso de Uso: Fazer requerimento
                            <button type="submit" class="inline">EXCLUIR</button>
                            <button type="submit" class="inline">EDITAR</button>
                        </div>
                    </div>
